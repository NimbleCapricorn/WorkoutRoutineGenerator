...
Weeks=[Week(Volume.LOW,"LIGHT"), Week(Volume.MED,"HEAVYP")] #Not advised pairings are HIGH volume with MODP and up intensity (except for enhanced athletes), LOW volume with MOD and down intensity (only for deloads)
